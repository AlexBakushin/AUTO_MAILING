...
from main.views import index, MassageListView, MassageDetailView, MassageCreateView, MassageUpdateView, \
    MassageDeleteView, MassageReportListView, ClientListView, ClientDetailView, ClientCreateView, ClientUpdateView, \
    ClientDeleteView
...
urlpatterns = [
    ...
    path('report/', MassageReportListView.as_view(), name='report'),
